...
# SPECIFICATION: This program trains a Bayesian classifier and predicts temperature from samples from weather_test.csv
...
def prepare_dataset(df: pd.DataFrame) -> tuple[np.ndarray, np.ndarray]:
    ...
    # Without data-time features
    return other_features, y_values
